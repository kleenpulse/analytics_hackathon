	...
	return (
		<>
			...
			>
				...
				>
					<div className="flex flex-nowrap items-center justify-between  w-full min-w-[600px]  border-b border-[#edf2f6] dark:border-success/20 text-[#9ca4ab]  dark:text-gray-300  pb-3 ">
					...
					<div className="flex w-full h-[420px] hide-scroll overflow-auto min-w-[600px] flex-col  -mt-[14px]">
						{filterUsers.slice(0, usersNum).map((data, index) => (
							...
							>
								...
								<button
									...
									className="text-sm min-[700px]:textbase  font-medium w-full max-w-[100px] text-main-sec  dark:text-gray-100  flex  gap-x-2 items-center  h-full"
								>
