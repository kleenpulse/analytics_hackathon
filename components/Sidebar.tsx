...
const Sidebar = () => {
	...
	return (
		...
		>
			<div
				className={cn(
					"flex flex-col gap-y-4  w-full  relative group-hover:items-start group-hover:pl-4 transition-all duration-300",
			...
			>
					...
					>
						...
						<span
							className={cn(
								...
								{
									"translate-x-52 group-hover/btn:translate-x-48": openSidebar,
								}
							)}
						>
							{shrinkString({
				...
				<div
					className={cn(
						"group-hover:w-full  transition-transform duration-300 group-hover:flex justify-center group-hover:-rotate-90",
						openSidebar ? "flex justify-center -rotate-90 w-full" : ""
					)}
				>
					<ThemeButtons />
				</div>
