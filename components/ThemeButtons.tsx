...
const ThemeButtons = () => {
	const { theme, setTheme } = useStateCtx();
	return (
		<div
			className={cn(
				"flex flex-col gap-y-4 p-2 items-center  rounded-full w-[46px] h-[92px] justify-between bg-white dark:bg-secondary transition-all duration-700 relative before:content-[''] before:absolute before:h-[30px] before:w-[30px] before:bg-success before:rounded-full  ",
